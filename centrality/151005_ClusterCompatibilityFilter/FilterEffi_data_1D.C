...
const int Ncut = 5;
void FilterEffi_data_mc_1D(const char* fname="/afs/cern.ch/work/y/ygo/public/centrality/merged_centrality_MB_DATA750_RECO_150914.root", TString type="RECO_750")
{
...
//======================================
    ...
    c_temp -> cd();
    t_evt -> Draw("hiHF >>+ HFsum_data0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
    HFsum_data[0] = (TH1D*)gDirectory->Get("HFsum_data0");
    t_evt -> Draw("hiHF >>+ HFsum_data1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    HFsum_data[1] = (TH1D*)gDirectory->Get("HFsum_data1");
    t_evt -> Draw("hiHF >>+ HFsum_data2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    HFsum_data[2] = (TH1D*)gDirectory->Get("HFsum_data2");
    t_evt -> Draw("hiHF >>+ HFsum_data3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    HFsum_data[3] = (TH1D*)gDirectory->Get("HFsum_data3");
    t_evt -> Draw("hiHF >>+ HFsum_data4",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
...
//======================================
    ...
    for(int i=0; i<Ncut; i++)
    {
        ...
        HFNpix_data[i] -> SetMarkerColor(kRed+i);
    }
    c_temp -> cd();
    t_evt -> Draw("hiNpix >>+ HFNpix_data0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
    HFNpix_data[0] = (TH1D*)gDirectory->Get("HFNpix_data0");
    t_evt -> Draw("hiNpix >>+ HFNpix_data1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    HFNpix_data[1] = (TH1D*)gDirectory->Get("HFNpix_data1");
    t_evt -> Draw("hiNpix >>+ HFNpix_data2", eventCut && "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    HFNpix_data[2] = (TH1D*)gDirectory->Get("HFNpix_data2");
    t_evt -> Draw("hiNpix >>+ HFNpix_data3", eventCut && "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    HFNpix_data[3] = (TH1D*)gDirectory->Get("HFNpix_data3");
    t_evt -> Draw("hiNpix >>+ HFNpix_data4",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
...
//=========================
    ...
    c_temp -> cd();
    t_evt -> Draw("hiBin >>+ HFBin_data0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
    HFBin_data[0] = (TH1D*)gDirectory->Get("HFBin_data0");
    t_evt -> Draw("hiBin >>+ HFBin_data1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    HFBin_data[1] = (TH1D*)gDirectory->Get("HFBin_data1");
    t_evt -> Draw("hiBin >>+ HFBin_data2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    HFBin_data[2] = (TH1D*)gDirectory->Get("HFBin_data2");
    t_evt -> Draw("hiBin >>+ HFBin_data3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    HFBin_data[3] = (TH1D*)gDirectory->Get("HFBin_data3");
    t_evt -> Draw("hiBin >>+ HFBin_data4",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
...
// ======================================
    ...
    c_temp -> cd();
    t_evt -> Draw("hiZDC>>+ hiZDC_data0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
    hiZDC_data[0] = (TH1D*)gDirectory->Get("hiZDC_data0");
    t_evt -> Draw("hiZDC>>+ hiZDC_data1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    hiZDC_data[1] = (TH1D*)gDirectory->Get("hiZDC_data1");
    t_evt -> Draw("hiZDC>>+ hiZDC_data2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    hiZDC_data[2] = (TH1D*)gDirectory->Get("hiZDC_data2");
    t_evt -> Draw("hiZDC>>+ hiZDC_data3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    hiZDC_data[3] = (TH1D*)gDirectory->Get("hiZDC_data3");
    t_evt -> Draw("hiZDC>>+ hiZDC_data4",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
...
// ======================================
    ...
    c_temp -> cd();
    t_evt -> Draw("hiEE>>+ hiEE_data0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
    hiEE_data[0] = (TH1D*)gDirectory->Get("hiEE_data0");
    t_evt -> Draw("hiEE>>+ hiEE_data1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    hiEE_data[1] = (TH1D*)gDirectory->Get("hiEE_data1");
    t_evt -> Draw("hiEE>>+ hiEE_data2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    hiEE_data[2] = (TH1D*)gDirectory->Get("hiEE_data2");
    t_evt -> Draw("hiEE>>+ hiEE_data3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    hiEE_data[3] = (TH1D*)gDirectory->Get("hiEE_data3");
    t_evt -> Draw("hiEE>>+ hiEE_data4",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
...
// ======================================
    ...
    c_temp -> cd();
    t_evt -> Draw("hiET>>+ hiET_data0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
    hiET_data[0] = (TH1D*)gDirectory->Get("hiET_data0");
    t_evt -> Draw("hiET>>+ hiET_data1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    hiET_data[1] = (TH1D*)gDirectory->Get("hiET_data1");
    t_evt -> Draw("hiET>>+ hiET_data2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    hiET_data[2] = (TH1D*)gDirectory->Get("hiET_data2");
    t_evt -> Draw("hiET>>+ hiET_data3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    hiET_data[3] = (TH1D*)gDirectory->Get("hiET_data3");
    t_evt -> Draw("hiET>>+ hiET_data4",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
...
// ======================================
    ...
    c_temp -> cd();
    t_evt -> Draw("hiEB>>+ hiEB_data0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
    hiEB_data[0] = (TH1D*)gDirectory->Get("hiEB_data0");
    t_evt -> Draw("hiEB>>+ hiEB_data1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    hiEB_data[1] = (TH1D*)gDirectory->Get("hiEB_data1");
    t_evt -> Draw("hiEB>>+ hiEB_data2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    hiEB_data[2] = (TH1D*)gDirectory->Get("hiEB_data2");
    t_evt -> Draw("hiEB>>+ hiEB_data3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    hiEB_data[3] = (TH1D*)gDirectory->Get("hiEB_data3");
    t_evt -> Draw("hiEB>>+ hiEB_data4",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
...
// ======================================
    ...
    c_temp -> cd();
    t_evt -> Draw("hiEvtPlanes>>+ hiEvtPlanes_data0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
    hiEvtPlanes_data[0] = (TH1D*)gDirectory->Get("hiEvtPlanes_data0");
    t_evt -> Draw("hiEvtPlanes>>+ hiEvtPlanes_data1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    hiEvtPlanes_data[1] = (TH1D*)gDirectory->Get("hiEvtPlanes_data1");
    t_evt -> Draw("hiEvtPlanes>>+ hiEvtPlanes_data2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    hiEvtPlanes_data[2] = (TH1D*)gDirectory->Get("hiEvtPlanes_data2");
    t_evt -> Draw("hiEvtPlanes>>+ hiEvtPlanes_data3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    hiEvtPlanes_data[3] = (TH1D*)gDirectory->Get("hiEvtPlanes_data3");
    t_evt -> Draw("hiEvtPlanes>>+ hiEvtPlanes_data4",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
