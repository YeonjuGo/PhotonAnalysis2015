...
const int nfilter = 5;
const char* evtfilter[] = {"","HLT_HIL1MinimumBiasHF1ANDExpress_v1", "HLT_HIL1MinimumBiasHF1ANDExpress_v1 && phfCoincFilter3", "HLT_HIL1MinimumBiasHF1ANDExpress_v1 && pprimaryVertexFilter","HLT_HIL1MinimumBiasHF1ANDExpress_v1 && phfCoincFilter3 && pprimaryVertexFilter"};
...
void filterDep_2D(const char* fname="root://eoscms//eos/cms/store/group/phys_heavyions/velicanu/forest/Run2015E/HIExpressPhysics/Merged/HIForestExpress_run262548-v2.root",
        TCut trig = "")
