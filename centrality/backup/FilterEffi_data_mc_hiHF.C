...
void FilterEffi_data_mc_hiHF()
{
    ...
    const double HFsum_bins[] = {0,2,5,10,15,20,30,40,50,60,70,80,90,100,200,300,400,500,1000,2000,3000,4000,5000,6000};
    ...
    {
        HFsum_data[i] = new TH1D(Form("HFsum_data%d",i), ";hiHF;Normalized Events",n_HFsum_bins, HFsum_bins); // when you look at efficiency
        //HFsum_data[i] = new TH1D(Form("HFsum_data%d",i), ";hiHF;Normalized Events",100,0,6000); // when you look at the whole distribution
        ...
        HFsum_mc[i] = (TH1D*) HFsum_data[i]->Clone(Form("HFsum_mc%d",i));
        HFsum_mc[i] -> SetMarkerStyle(1);
    ...
    cout << "HFsum_mc[0] () Entries : " << HFsum_mc[0]->GetEntries() << endl;
    cout << "HFsum_mc[1] (pprimaryVertexFilter==1) Entries : " << HFsum_mc[1]->GetEntries() << endl;
    cout << "HFsum_mc[2] (phltPixelClusterShapeFilter==1) Entries : " << HFsum_mc[2]->GetEntries() << endl;
    cout << "HFsum_mc[3] (phfCoincFilter3==1) Entries : " << HFsum_mc[3]->GetEntries() << endl;
    cout << "HFsum_mc[4] (pcollisionEventSelection==1) Entries : " << HFsum_mc[4]->GetEntries() << endl;

    cout << "HFsum_data[0] () Entries : " << HFsum_data[0]->GetEntries() << endl;
    cout << "HFsum_data[1] (pprimaryVertexFilter==1) Entries : " << HFsum_data[1]->GetEntries() << endl;
    cout << "HFsum_data[2] (phltPixelClusterShapeFilter==1) Entries : " << HFsum_data[2]->GetEntries() << endl;
    cout << "HFsum_data[3] (phfCoincFilter3==1) Entries : " << HFsum_data[3]->GetEntries() << endl;
    cout << "HFsum_data[4] (pcollisionEventSelection==1) Entries : " << HFsum_data[4]->GetEntries() << endl;
