...
void yj_analyze(const char* infile = "/home/goyeonju/CMS/Files/centrality/HiForest_HydjetMB_730_53XBS_merged.root", const char* outfile = "output.root"){
  ...
  c1->cd(7);
  //  t1->Draw(Form("hiHFhit:hiNpix),trig,"colz");
