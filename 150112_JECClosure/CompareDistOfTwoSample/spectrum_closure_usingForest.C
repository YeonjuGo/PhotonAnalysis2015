...
// one sample is skimed. the other is not skimed and just forest.
...
void spectrum_closure_usingForest(bool doWeight=0){
...
//	TFile* alexFile = new TFile("/u/user/goyeonju/2014/141215_JECClosure/test/leadingpho40_pPb30_photonThreshold25_temp.root");
	...
	//TFile* alexFile = new TFile("/u/user/goyeonju/PRODUCTION/CMSSW_5_3_20/src/pPb_JEC/merging-forest/pPbAllQCD30/JEC_pPbAllQCD30.root");
...
//======================================
	...
	if(doWeight==1) alexTree_pho -> Draw("pt>>+alexpt", "weight*(pt<1000)");
	else alexTree_pho -> Draw("pt>>+alexpt", "(pt<1000)");
