...
//
// leading photon condition X, only pthat30, photon threshold cut is applied
#include "TFile.h"
#include "TTree.h"
#include "TNtuple.h"
#include "TH1D.h"
