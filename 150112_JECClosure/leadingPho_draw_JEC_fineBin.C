...
const Double_t ptbins[] = {30,35,40,45,50,55,60,70,80,90,100,110,120};
...
void leadingPho_draw_JEC_fineBin(const char *calgo="ak3PF",const char *calgoDir="ak3PF_gaus", bool savePlots=1, bool fitting=1){
	TH1::SetDefaultSumw2();
	gStyle->SetOptStat(0);
