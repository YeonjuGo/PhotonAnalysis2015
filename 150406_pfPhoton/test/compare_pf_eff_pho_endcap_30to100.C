...
void compare_pf_eff_pho_endcap_30to100(){

	const int pfid = 4; // unknown : 0, charged hadron : 1, electron : 2, muon : 3, photon : 4, neutral hadron : 5, h_HF : 6, egamma_HF : 7
	const int pdgid = 22; // electron (11 or -11) , photon 22
...
//	l1->Draw("same");	
	...
	c1-> SaveAs("pdf/compare_pf_eff_photon_endcap_cent30to100.pdf");
} // main function
