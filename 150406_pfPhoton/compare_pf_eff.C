...
void compare_pf_eff(const int pfid=2, const int pdgid=11, const int ptThr=10, const int centLow = 0, const int centUp=20, const float etaLow = 0, const float etaUp = 1.44){
