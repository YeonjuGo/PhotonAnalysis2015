...
lcg-ls --offset 0 --count 999 srm://cluster142.knu.ac.kr:8443/srm/managerv2?SFN=/pnfs/knu.ac.kr/data/cms/store/user/ygo/2014-photon-forests/$datasets >& tmp_list_$datasets.txt
