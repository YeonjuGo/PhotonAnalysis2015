        ...
        const char* cap="photon_DATA_MC")
{
   // gROOT->Reset();
    ...
    double eErrMax_endcap = 0.5;
    //double eErrMax_barrel = 0.5;
    //double eErrMax_endcap = 2.0;
    int eBin = 100;
    double eMax = 300;
   
    const char* cut0 = "pcollisionEventSelection>0 && Max$(phoEt)>30";
    TString addcap0 = "evtSel_leadingPho30";
    compareTwo_ratio(tee[0],tee[1],"chi2",70,0,70,Form("%s",cut0),Form("%s_%s",cap, Form("%s",addcap0.Data()) ));
    compareTwo_ratio(teb[0],teb[1],"chi2",70,0,70,Form("%s",cut0),Form("%s_%s",cap, Form("%s",addcap0.Data()) ));
    compareTwo_ratio(tee[0],tee[1],"eError",eErrBin,0,eErrMax_endcap,Form("%s",cut0),Form("%s_%s",cap, Form("%s",addcap0.Data()) ));
    compareTwo_ratio(teb[0],teb[1],"eError",eErrBin,0,eErrMax_barrel,Form("%s",cut0),Form("%s_%s",cap, Form("%s",addcap0.Data()) ));
...
//    const char* cut1 = "hiNtracks<50 && hiNtracks>0 && pcollisionEventSelection>0 && Max$(phoEt)>30";
    ...
    compareTwo_ratio(tee[0],tee[1],"chi2",70,0,70,Form("%s",cut1),Form("%s_%s",cap, Form("%s",addcap1.Data()) ));
    compareTwo_ratio(teb[0],teb[1],"chi2",70,0,70,Form("%s",cut1),Form("%s_%s",cap, Form("%s",addcap1.Data()) ));
...
//    const char* cut2 = "hiNtracks>1000 && pcollisionEventSelection>0 && Max$(phoEt)>30";
    ...
    compareTwo_ratio(tee[0],tee[1],"chi2",70,0,70,Form("%s",cut2),Form("%s_%s",cap, Form("%s",addcap2.Data()) ));
    compareTwo_ratio(teb[0],teb[1],"chi2",70,0,70,Form("%s",cut2),Form("%s_%s",cap, Form("%s",addcap2.Data()) ));
    ...
    for(int i=0;i<2;i++){
        ...
        draw_2D(teb[0],"chi2","eError", 70,0,70, eErrBin,0,eErrMax_barrel,cut0,tmpSt);
        draw_2D(tee[0],"chi2","eError", 70,0,70, eErrBin,0,eErrMax_endcap,cut0,tmpSt);
        draw_2D(teb[0],"e","eError", eBin,0,eMax, eErrBin,0,eErrMax_barrel,cut0,tmpSt);
        draw_2D(tee[0],"e","eError", eBin,0,eMax, eErrBin,0,eErrMax_endcap,cut0,tmpSt);
        tmpSt = addcap1 + sample;
        draw_2D(teb[0],"chi2","eError", 70,0,70, eErrBin,0,eErrMax_barrel,cut1,tmpSt);
        draw_2D(tee[0],"chi2","eError", 70,0,70, eErrBin,0,eErrMax_endcap,cut1,tmpSt);
        draw_2D(teb[0],"e","eError", eBin,0,eMax, eErrBin,0,eErrMax_barrel,cut1,tmpSt);
        draw_2D(tee[0],"e","eError", eBin,0,eMax, eErrBin,0,eErrMax_endcap,cut1,tmpSt);
        tmpSt = addcap2 + sample;
        draw_2D(teb[0],"chi2","eError", 70,0,70, eErrBin,0,eErrMax_barrel,cut2,tmpSt);
        draw_2D(tee[0],"chi2","eError", 70,0,70, eErrBin,0,eErrMax_endcap,cut2,tmpSt);
        draw_2D(teb[0],"e","eError", eBin,0,eMax, eErrBin,0,eErrMax_barrel,cut2,tmpSt);
        draw_2D(tee[0],"e","eError", eBin,0,eMax, eErrBin,0,eErrMax_endcap,cut2,tmpSt);
    }
