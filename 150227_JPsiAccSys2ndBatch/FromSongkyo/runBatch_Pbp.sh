...
# Non-prompt MC
mc1=/afs/cern.ch/work/k/kyolee/private/pAJpsi_rooDataSet_mcTwoWay_zVtxCutWeight/outRoo_NPMC_Pbp_mcTwoWay/outRoo_NPMC_Pbp_mcTwoWay.root
# Prompt MC
mc2=/afs/cern.ch/work/k/kyolee/private/pAJpsi_rooDataSet_mcTwoWay_zVtxCutWeight/outRoo_PRMC_Pbp_mcTwoWay/outRoo_PRMC_Pbp_mcTwoWay.root
...
rapFineCheck=(-2.4--1.97 -1.97--1.37 -1.37--0.47 -0.47-0.43 0.43-1.03 1.03-1.46 1.46-1.93 1.93-2.4)
#rapFineCheck=(-2.4--1.97 -1.97--1.67 -1.67--1.37 -1.37--0.97 -0.97--0.47 -0.47-0.03 0.03-0.43 0.43-0.73 0.73-1.03 1.03-1.46 1.46-1.93 1.93-2.4)
ptFineCheck=(0.0-3.0 3.0-4.0 4.0-5.0 5.0-6.5 6.5-7.5 7.5-8.5 8.5-10.0 10.0-14.0 14.0-30.0)
#ptFineCheck=(0.0-1.0 1.0-2.0 2.0-3.0 3.0-4.0 4.0-5.0 5.0-6.5 6.5-7.5 7.5-8.5 8.5-10.0 10.0-14.0 14.0-30.0)
#ptFineCheck=(0.0-1.0 1.0-2.0 2.0-3.0 3.0-4.0 4.0-5.0 5.0-6.5 6.5-7.5 7.5-8.5 8.5-9.5 9.5-11.0 11.0-14.0 14.0-30.0)

#ethfRFB=(0.0-20.0 20.0-25.0 25.0-30.0 30.0-40.0 40.0-120.0)
...
### 8rap9pt
for rap in ${rapFineCheck[@]}; do
	for pt in ${ptFineCheck[@]}; do
		program $rap $pt $ntrkRFB $ethfRFB 0.0-100.0
	done
done

#program -2.4--1.97 0.0-3.0 $ntrkRFB $ethfRFB 0.0-100.0 
#program 1.93-2.4 0.0-3.0 $ntrkRFB $ethfRFB 0.0-100.0 

### with sigmaResSigW, meanResSigW release
'''
program -2.4--1.97 7.5-8.5 $ntrkRFB $ethfRFB 0.0-100.0 
program -2.4--1.97 8.5-10.0 $ntrkRFB $ethfRFB 0.0-100.0 
program -1.97--1.37 4.0-5.0 $ntrkRFB $ethfRFB 0.0-100.0 
program -1.97--1.37 5.0-6.5 $ntrkRFB $ethfRFB 0.0-100.0 
program -0.47-0.43 6.5-7.5 $ntrkRFB $ethfRFB 0.0-100.0 
program 0.43-1.03 6.5-7.5 $ntrkRFB $ethfRFB 0.0-100.0 
program 1.93-2.4 4.0-5.0 $ntrkRFB $ethfRFB 0.0-100.0 
program 1.93-2.4 6.5-7.5 $ntrkRFB $ethfRFB 0.0-100.0 
'''

### most bw, high pT
#program 1.93-2.4 10.0-14.0 $ntrkRFB $ethfRFB 0.0-100.0 #for 10-14, 14-30 
#program 1.93-2.4 14.0-30.0 $ntrkRFB $ethfRFB 0.0-100.0 #for 10-14, 14-30 
### for 10-14, 14-30 
#program 1.93-2.4 10.0-30.0 $ntrkRFB $ethfRFB 0.0-100.0 #for 10-14, 14-30 
#program 1.46-2.4 10.0-14.0 $ntrkRFB $ethfRFB 0.0-100.0 #for 10-14, 14-30 
#program 1.46-2.4 14.0-30.0 $ntrkRFB $ethfRFB 0.0-100.0 #for 10-14, 14-30 
