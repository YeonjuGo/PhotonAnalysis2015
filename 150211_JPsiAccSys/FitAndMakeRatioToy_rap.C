...
void FitAndMakeRatioToy_rap(int nToy=1, bool isPrompt=true, bool isPbp=true){
	gRandom->SetSeed(time(0));
	TFile* fin = new TFile(Form("/u/user/goyeonju/2015/pPbJPsiAnalysis/2015/004_closure/DataMcReco_rapIntegPt_8rap9pt/data_mc_reco_rap_isPrompt%d.root",(int)isPrompt)); 
