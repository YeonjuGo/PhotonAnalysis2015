...
root -l -b -q 'makeSkimGenMatching_HiGenTree.C++("/afs/cern.ch/work/y/ygo/public/PFphoton/merged_SingleGammaFlatPt10To200_pythia8_FOREST_753p1.root", "SingleGammaFlatPt10To200", "ggHiNtuplizer",1)'
root -l -b -q 'makeSkimGenMatching_HiGenTree.C+("/afs/cern.ch/work/y/ygo/public/PFphoton/merged_SingleGammaFlatPt10To200_pythia8_FOREST_753p1.root", "SingleGammaFlatPt10To200", "ggHiNtuplizerGED",1)'
