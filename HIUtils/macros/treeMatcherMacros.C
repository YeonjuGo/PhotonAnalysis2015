...
//    int differentBranches = compareTreesVerbose(tree1, tree2, 0, NULL, true);

    int differentBranches = compareTreesVerbose(new TFile(filePath1), treePath1,
                                                new TFile(filePath2), treePath2,
                                                0, NULL, true);
...
//    const char* dir2="/mnt/hadoop/cms/store/user/richard/reLinkingTest/RelValZEEMM_13_HI/RelValZEEMM_13_HI_mnguyen-PFup_RelValZEEMM_13_HI_CMSSW_7_6_0_pre4-76X_mcRun2_HeavyIon_v1_HiForest/150924_204237/0000/";
    ...
    const char* dir="/mnt/hadoop/cms/store/user/tatar/reLinkingTest/RelValZEEMM_13_HI";

    std::string filePath1str = Form("%s/HiForest_merged_CMSSW_7_6_0_pre4.root",dir);
    std::string filePath2str = Form("%s/HiForest_merged_mnguyen_sorted.root",dir);

    std::cout << "comparing files" <<std::endl;
    std::cout << "file1 = " << filePath1str.c_str() <<std::endl;
    std::cout << "file2 = " << filePath2str.c_str() <<std::endl;
...
//    sortTrees(filePath1, filePath2);
    ...
    treePaths1.push_back("ggHiNtuplizer/EventTree");
    treePaths1.push_back("ggHiNtuplizerGED/EventTree");
    treePaths1.push_back("akPu3CaloJetAnalyzer/t");
    treePaths1.push_back("akVs3CaloJetAnalyzer/t");
    treePaths1.push_back("akVs3PFJetAnalyzer/t");
    treePaths1.push_back("akPu3PFJetAnalyzer/t");
    treePaths1.push_back("akPu4CaloJetAnalyzer/t");
    treePaths1.push_back("akVs4CaloJetAnalyzer/t");
    treePaths1.push_back("akVs4PFJetAnalyzer/t");
    treePaths1.push_back("akPu4PFJetAnalyzer/t");

    treePaths2.push_back("ggHiNtuplizer_EventTree");
    treePaths2.push_back("ggHiNtuplizerGED_EventTree");
    treePaths2.push_back("akPu3CaloJetAnalyzer_t");
    treePaths2.push_back("akVs3CaloJetAnalyzer_t");
    treePaths2.push_back("akVs3PFJetAnalyzer_t");
    treePaths2.push_back("akPu3PFJetAnalyzer_t");
    treePaths2.push_back("akPu4CaloJetAnalyzer_t");
    treePaths2.push_back("akVs4CaloJetAnalyzer_t");
    treePaths2.push_back("akVs4PFJetAnalyzer_t");
    treePaths2.push_back("akPu4PFJetAnalyzer_t");

    for (size_t i=0; i<treePaths1.size(); ++i)
    {
        std::cout << "comparing tree : " << treePaths1.at(i).c_str() << std::endl;
        int numDifferentBranches = compareTreesBitWise_v3(filePath1str.c_str(), filePath2str.c_str(), treePaths1.at(i).c_str(), treePaths2.at(i).c_str());
        std::cout << "numDifferentBranches = " << numDifferentBranches << std::endl;
        std::cout << "comparing tree FINISHED : " << treePaths1.at(i).c_str() << std::endl;
    }
